...
typedef NS_ENUM(NSInteger, WFWahooMotionAnalysisActivityType_t) {
    ...
    WF_WAHOO_MOTION_ANALYSIS_ACTIVITY_TYPE_DEPRECATED_00            = 1,
    ...
    WF_WAHOO_MOTION_ANALYSIS_ACTIVITY_TYPE_ELLIPTICAL               = 7,
};
...
// +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+
/**@name Specific Fields for activityType = WF_WAHOO_MOTION_ANALYSIS_ACTIVITY_TYPE_RUNNING */
/**@{*/

@property (nonatomic, retain) NSNumber* runningSquaredJerkX;    /**< A measure of the current jerk in the x direction of the device.<BR>The value is squared, take the square root to obtain the original value.<BR>Units are m<sup>2</sup>/s<sup>5</sup>. */
@property (nonatomic, retain) NSNumber* runningSquaredJerkY;    /**< A measure of the current jerk in the y direction of the device.<BR>The value is squared, take the square root to obtain the original value.<BR>Units are m<sup>2</sup>/s<sup>5</sup>. */
@property (nonatomic, retain) NSNumber* runningSquaredJerkZ;    /**< A measure of the current jerk in the z direction of the device.<BR>The value is squared, take the square root to obtain the original value.<BR>Units are m<sup>2</sup>/s<sup>5</sup>. */
...
// +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+
#pragma mark - Specific Fields for activityType = Elliptical
/**@name Specific Fields for activityType = WF_WAHOO_MOTION_ANALYSIS_ACTIVITY_TYPE_ELLIPTICAL */
/**@{*/
@property (nonatomic, retain) NSNumber *ellipticalInstantaneousSpeed;
/**@}*/
